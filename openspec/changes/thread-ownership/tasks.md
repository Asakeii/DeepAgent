...
- [x] Add `users` and `threads` schema.
- [x] Add identity table bootstrap during DB init.
- [x] Add user/thread ownership store helpers.
- [x] Ensure chat/check-in writes bind to a user-owned thread.
